...
$DB_FOLDER = MOPO_SERVER_FOLDER.FOLDER_DB_TIMER;
...
if (SIDE_NAV_INIT('')) {
	if ('' != $page_title) {
		...
		PAGE_ADD('<h2>依班別</h2>');
			REPORT_QUERY_INIT(RETURN_HIDDEN_INPUT_ELEMENT(QUERY_TYPE_NAME, QUERY_TYPE_TIMER_CLASS));
			$qpi_count = 0;
